...
*/
-- DropForeignKey
ALTER TABLE "transacitons" DROP CONSTRAINT "transacitons_bank_account_id_fkey";

-- DropForeignKey
ALTER TABLE "transacitons" DROP CONSTRAINT "transacitons_category_id_fkey";

-- DropForeignKey
ALTER TABLE "transacitons" DROP CONSTRAINT "transacitons_user_id_fkey";
